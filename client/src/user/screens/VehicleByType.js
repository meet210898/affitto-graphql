...
import { VEHICLES_BY_TYPE } from "../../gqloperations/mutation";
...
const VehicleByType = () => {
  ...
  const [vehicleByType] = useMutation(VEHICLES_BY_TYPE, {
    onCompleted: (data) => setVehicleByTypeData(data),
  ...
  return (
    <>
      <Topbar />
      {vehicleByTypeData?.vehicle?.length === 0 ? (
        ...
        <Grid container>
          ...
          <Grid xs={10}>
            ...
            <Grid container display="flex">
              {vehicleByTypeData?.vehicle?.map((row) => (
