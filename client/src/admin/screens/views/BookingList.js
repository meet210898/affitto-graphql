    ...
    return (
        <TableContainer component={Paper}>
            <Table sx={{ minWidth: 700 }} aria-label="customized table">
                ...
                <TableBody>
                    {data?.booking?.slice(0).reverse().map((row, index) => (
                        <StyledTableRow key={index}>
                            ...
                            <StyledTableCell align="left">{row.vehicleId.vehicleName}</StyledTableCell>
                            ...
                            <StyledTableCell align="left">{row.status ? "Approved" : "Pending"}</StyledTableCell>
                        </StyledTableRow>
                    ))}
                </TableBody>
            </Table>
