...
import { GET_ALL_COMPANIES, GET_ALL_VEHICLETYPES } from '../../../gqloperations/queries'
...
const AddVehicle = () => {
    ...
    return (
        ...
        >
            {
                vehicleTypeInfo?.error && <div className="red card-panel">{vehicleTypeInfo?.error.message}</div>
            }
